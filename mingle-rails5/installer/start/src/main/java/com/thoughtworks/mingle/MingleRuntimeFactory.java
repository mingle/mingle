...
public class MingleRuntimeFactory  extends RailsRackApplicationFactory {
    ...
    MingleRuntimeFactory(String contextPath, int dbConnectionPoolSize, String appRootDir) {
    ...
    public RubyInstanceConfig createRuntimeConfig() {
        ...
        config.setLoadServiceCreator(runtime -> new MingleLoadService(runtime, appRootDir));
        return config;
    }
    ...
    public IRubyObject createApplicationObject(Ruby ruby) {
        ...
        try {
            ...
            System.out.printf("Failed to create application object: %s%s%n", e.getMessage(), e);
