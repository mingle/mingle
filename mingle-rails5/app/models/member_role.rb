...
class MemberRole < ApplicationRecord
  ...
  scope :user_deliverable_roles, -> (user, deliverable){ where member_id: user.id, member_type: user.class.name, deliverable_id: deliverable.id }

  module AssociationOverrides
    def role
  ...
  module AssociationExt
    ...
    def setup_role_for_member(member, role)
      ...
      member_role = find_by_member(member) || new(scope_for_create.merge(:member => member))
