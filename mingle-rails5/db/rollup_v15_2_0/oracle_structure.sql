...
create sequence GADGETS_OAUTH_CLIENTS_SEQ;
...
create sequence OAUTH_AUTHORIZATION_CODES_SEQ;
...
create table ASYNCH_REQUESTS (
 ...
 progress_message varchar2(1000 char),
 ...
 message clob,
 deliverable_identifier varchar2(255 char) not null,
 tmp_file varchar2(255 char));

create table ATTACHINGS (
 id number(38,0) not null primary key ,
 attachment_id number(38,0) not null,
 attachable_id number(38,0) not null,
 attachable_type varchar2(255 char));

create table ATTACHMENTS (
 id number(38,0) not null primary key ,
 "FILE" varchar2(255 char) default ''  not null,
 path varchar2(255 char) default ''  not null,
...
create table BACKLOG_OBJECTIVES (
 ...
 value_statement varchar2(750 char) default null);

create table CACHE_KEYS (
 id number(38,0) not null primary key ,
 deliverable_id number(38,0),
 structure_key varchar2(255 char),
 created_at date,
 updated_at date,
 card_key varchar2(255 char),
 feed_key varchar2(255 char),
 deliverable_type varchar2(255 char) default 'Project'  not null);
...
create table CARDS (
 ...
 version number(38,0),
 card_type_name varchar2(255 char) not null,
...
create table DELIVERABLES (
 id number(38,0) not null primary key ,
 name varchar2(255 char) default ''  not null,
 identifier varchar2(255 char) default '' ,
 description clob,
 created_at date not null,
 updated_at date not null,
 ...
 card_keywords varchar2(255 char),
 template number(1,0),
 secret_key varchar2(255 char),
 email_address varchar2(255 char),
 email_sender_name varchar2(255 char),
 hidden number(1,0) default 0,
 date_format varchar2(255 char) default '%d %b %Y',
 ...
 auto_enroll_user_type varchar2(255 char) default null,
 cards_table varchar2(255 char),
 card_versions_table varchar2(255 char),
...
create table DEPENDENCIES (
 ...
 raising_card_id number(38,0) not null,
 "NUMBER" number(38,0),
 created_at date,
 raising_user_id number(38,0),
 status varchar2(255 char) default 'NEW' not null,
 version number(38,0));
...
create table DEPENDENCY_RESOLVING_CARDS (
 ...
 dependency_type varchar2(255 char));
...
create table DEPENDENCY_VIEWS (
 ...
 project_id number(38,0) not null,
 user_id number(38,0) not null,
 params varchar2(1000 char),
 created_at date,
 updated_at date);

create table ENUMERATION_VALUES (
 id number(38,0) not null primary key ,
 value varchar2(255 char) default ''  not null,
...
create table FAVORITES (
 id number(38,0) not null primary key ,
 project_id number(38,0) not null,
 favorited_type varchar2(255 char) not null,
...
create table GADGETS_OAUTH_CLIENTS (
 id number(38,0) not null primary key ,
 oauth_authorize_url varchar2(255 char),
...
create table GIT_CONFIGURATIONS (
 id number(38,0) not null primary key ,
 project_id number(38,0),
 repository_path varchar2(255 char),
 username varchar2(255 char),
...
create table HISTORY_SUBSCRIPTIONS (
 ...
 hashed_filter_params varchar2(255 char),
 filter_params clob,
...
create table LOGIN_ACCESS (
 id number(38,0) not null primary key ,
 user_id number(38,0) not null,
 login_token varchar2(255 char),
 last_login_at date,
 lost_password_key varchar2(1000 char),
...
create table LUAU_CONFIGS (
 ...
 client_key varchar2(255 char),
 auth_state_explanation varchar2(255 char),
 sync_status varchar2(255 char),
 last_sync_time date,
 marked_for_deletion number(1,0),
 client_digest varchar2(255 char),
...
create table MEMBER_ROLES (
 id number(38,0) not null primary key ,
 deliverable_id number(38,0) not null,
 member_type varchar2(255 char) not null,
...
create table MURMURS (
 id number(38,0) not null primary key ,
 project_id number(38,0) not null,
 packet_id varchar2(255 char),
 jabber_user_name varchar2(255 char),
 created_at date not null,
 author_id number(38,0),
 murmur clob,
 origin_type varchar2(255 char),
 origin_id number(38,0),
 type varchar2(255 char) default 'DefaultMurmur'  not null,
...
create table MURMUR_CHANNELS (
 id number(38,0) not null primary key ,
 project_id number(38,0) not null,
 jabber_chat_room_id varchar2(255 char),
 jabber_chat_room_status varchar2(255 char),
 enabled number(1,0),
 type varchar2(255 char) default 'BuiltInChannel');

create table OAUTH_ACCESS_TOKENS (
 id number(38,0) not null primary key ,
 gadgets_oauth_client_id number(38,0),
 user_id varchar2(255 char),
 access_token varchar2(255 char),
 refresh_token varchar2(255 char),
 expires_in number(38,0),
 created_at date,
 updated_at date);
...
create table OAUTH_CLIENTS (
 ...
 client_id varchar2(255 char),
 client_secret varchar2(255 char),
 redirect_uri varchar2(255 char),
 created_at date,
 updated_at date);
...
create table OBJECTIVE_VERSIONS (
 ...
 value_statement varchar2(750 char),
...
create table PROPERTY_DEFINITIONS (
 ...
 name varchar2(255 char) default ''  not null,
 description clob,
 column_name varchar2(255 char) default ''  not null,
 ...
 ruby_name varchar2(255 char) default null,
 dependant_formulas varchar2(1000 char),
...
create table TABS (
 ...
 name varchar2(255 char),
 position number(38,0),
 tab_type varchar2(255 char) not null,
...
create table TAB_POSITIONS (
 id number(38,0) not null primary key ,
 project_id number(38,0),
 html_id varchar2(255 char) not null,
 position number(38,0));
...
create table TAGGINGS (
 ...
 taggable_type varchar2(255 char) not null);
...
create table TRANSITION_ACTIONS (
 ...
 value varchar2(255 char) default '',
 executor_type varchar2(255 char) not null,
 type varchar2(255 char),
...
create table USERS (
 ...
 password varchar2(255 char),
 admin number(1,0),
 version_control_user_name varchar2(255 char),
 login varchar2(255 char) default ''  not null,
 name varchar2(255 char),
 activated number(1,0) default 1,
 light number(1,0) default 0,
 icon varchar2(255 char),
 jabber_user_name varchar2(255 char),
 jabber_password varchar2(255 char),
 ...
 read_notification_digest varchar2(255 char),
 created_at date,
 updated_at date);
...
'  not null,
 ...
 timeline_granularity varchar2(255 char),
...
create table USER_FILTER_USAGES (
 ...
 filterable_type varchar2(255 char),
 user_id number(38,0));
...
create table WORKS (
 ...
 completed number(1,0),
 name varchar2(255 char),
 bulk_updater_id varchar2(255 char),
 project_id number(38,0));
...
create UNIQUE index UNIQ_TREE_NAME_IN_PROJECT ON TREE_CONFIGURATIONS("PROJECT_ID","NAME");
