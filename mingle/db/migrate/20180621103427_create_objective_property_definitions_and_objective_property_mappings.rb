...
class CreateObjectivePropertyDefinitionsAndObjectivePropertyMappings < ActiveRecord::Migration
  ...
  class << self
    ...
    def down
      remove_index(:objective_property_mappings, column:[:objective_property_definition_id, :objective_type_id])
      remove_index(:objective_property_definitions, column:[:program_id, :name])
