...
<body>
    ...
    Only those fragments longer than 2 lines of code are shown.
    <p/>
    <table border="1" class="summary" cellpadding="2">
      ...
      <tr>
        <td class="SummaryNumber"><xsl:value-of select="count(//duplication[@lines>2])"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>2]/@lines)"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>2]/@tokens)"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>2]/@tokens) * 4"/></td>
      </tr>
    </table>
    <p/>
    ...
    <xsl:for-each select="//duplication[@lines>2]">
