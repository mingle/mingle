...
public class GraphGenerator{
    ...
    public void createGraph(){
        try{
            generateGraph("tmp/heap_max.jpg",1);
            generateGraph("tmp/heap_used.jpg",2);
            generateGraph("tmp/heap_committed.jpg",3);
            generateGraph("tmp/gcConc_collection_time.jpg",4);
            generateGraph("tmp/gcConc_collection_count.jpg",5);
            generateGraph("tmp/gcPn_collection_time.jpg",6);
            generateGraph("tmp/gcPn_collection_count.jpg",7);
            generateHTML("tmp/memory_graph.html");
        }catch(Exception ex){
            ex.printStackTrace();
        }
    }
    ...
    private void generateGraph(String filename, int graphType) {
        try{
            XYDataset memoryData = new TimeSeriesCollection(getSeries(graphType));
    ...
    private TimeSeries getSeries(int graphType) throws Exception {
