...
module Rack
  ...
  module Utils
    ...
    DEFAULT_SEP = /[&;] */n unless defined?(DEFAULT_SEP)
    ...
    STATUS_WITH_NO_ENTITY_BODY = Set.new((100..199).to_a << 204 << 205 << 304) unless defined?(STATUS_WITH_NO_ENTITY_BODY)

    SYMBOL_TO_STATUS_CODE = Hash[*HTTP_STATUS_CODES.map { |code, message|
      [message.downcase.gsub(/\s|-/, '_').to_sym, code]
    }.flatten] unless defined?(SYMBOL_TO_STATUS_CODE)
