...
module Aws
  class RequestSignerSpec < ActiveSupport::TestCase
    def test_should_sign_the_request
      Timecop.travel(2016, 1, 1, 0, 0, 0, +5.5*60*60) do
        Timecop.freeze(DateTime.parse('18/11/2016 03:15:00 IST')) do
          ...
          req = Net::HTTP::Get.new('https://randomdomain.com/path/for/request?with=query&params=true')
