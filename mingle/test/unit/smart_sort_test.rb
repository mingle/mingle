...
class SmartSortTest < ActiveSupport::TestCase
  ...
  def test_sort_should_be_case_insensitive
    assert_equal ['apple', 'Banana','orange'], ['Banana', 'orange', 'apple'].smart_sort
  end
  ...
  def test_simple_mixed
    assert_equal ['1', '2', 'banana','orange'], ['banana','2', '1', 'orange'].smart_sort
    assert_equal ['1', '2','10','orange'], ['10','2', '1', 'orange'].smart_sort
  end
  ...
  def test_numeric_split
    ...
    assert_equal ['iteration', '1'], SmartSort.numeric_split('iteration1').collect(&:str)
    assert_equal ['iteration', '10'], SmartSort.numeric_split('iteration10').collect(&:str) 
    assert_equal ['10', 'iteration'], SmartSort.numeric_split('10iteration').collect(&:str) 
