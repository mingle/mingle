...
public class SetupTestEnvironment extends Constants {
    ...
    public SetupTestEnvironment(Browser browser, JRubyScriptRunner jRubyScriptRunner) {
    ...
    public void start() throws Exception {
        ...
        browser.navigateTo(this.getPlannerBaseUrl() + "/_class_method_call?class=SetupHelper&method=setup_for_planner_acceptance_tests");
    }
}
