...
public class RegisterLicenseOfType {
    ...
    public RegisterLicenseOfType(Browser browser, JRubyScriptRunner jRubyScriptRunner) {
	...
	public void setUp(String licenseType) throws Exception {
        ...
        MingleProjectFixture mingleAccess = new MingleProjectFixture(this.browser);
