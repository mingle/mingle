...
public class DataPrepare {
    ...
    public DataPrepare(JRubyScriptRunner jRubyScriptRunner) {
        this.scriptRunner = jRubyScriptRunner;
    }

    public void setUp(final String projectDataHelpMethod) throws Exception {
        this.scriptRunner.executeWithTestHelpers(new ScriptBuilder() {
            public void build(ScriptWriter scriptWriter) {
                scriptWriter.printfln(projectDataHelpMethod);
            }
        });
    }
