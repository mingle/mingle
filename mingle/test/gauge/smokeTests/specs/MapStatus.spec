...
tags: Plan, #11259, monitoring mode, track work, #11512, plan_projects_page, plan_work_page, group_a
...
* Assert save button disabled with message "The card types tracked by this definition are: storie's, Card"
