...
public class EnableAnonymousAccessForProject {
    ...
    public EnableAnonymousAccessForProject() {
    ...
    private void anonymousAccess(final String project, final boolean anonymous) {
        this.scriptRunner.executeWithBuilder(new JRubyScriptRunner.ScriptBuilder() {
            ...
            private void makeProjectAnonymouslyAccessibleScript(final String project, final boolean anonymous, JRubyScriptRunner.ScriptWriter writer) {
