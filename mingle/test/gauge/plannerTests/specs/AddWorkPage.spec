...
* Assert text present on the objective popup "You must add projects to this plan before you can add work."
* Open "Projects" page
...
* Navigate to objective "Payroll System" of plan "Finance Program"
* Assert Add work to this feature text present
...
* Assert flash message "25 cards added to the feature Payroll System."
...
* Assert the text for "There are no cards found for given filter."
...
* Remove "Story Status" indexed at "1" filter
...
* Remove "Type of test" indexed at "1" filter
* Select all cards
