...
* Assert text present on the team member page "2 members have been removed from the Finance Program team successfully."
...
* Assert text present on the page "Cannot remove yourself from program"
...
* Remove users "bob, user_10" from program
* Assert text present on the page "Cannot remove yourself from program"
* Select users "user_10"
* Remove users
* Assert that users "user_10" are not displayed on team members list
