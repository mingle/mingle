...
class ProjectDataExportPublisher
  ...
  def publish_message(export, project)
    ...
    send_message(ProjectDataExportProcessor::QUEUE, [message])
    export.total = export.total + ProjectDataExportProcessor.new.data_export_size
    message.dup
  end
