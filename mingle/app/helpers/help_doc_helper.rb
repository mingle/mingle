...
module HelpDocHelper
  ...
  SPECIALS = {
    ...
    'stack-bar-chart'      => '/ec_stacked_bar_charts.html',
    'data-series-chart'    => '/ec_data_series_charts.html',
    'daily-history-chart'  => '/ec_daily_history_charts.html',
    'cumulative-flow-graph'  => '/ec_cfg.html',
    'ratio-bar-chart'      => '/ec_ratiobar_chart.html',
    'pie-chart'            => '/ec_pie_charts.html',
  ...
  def link_to_help(page_uri)
    "#{MingleConfiguration.site_url}#{HELP_DOC_DOMAIN}#{PAGES[page_uri] || COMPONENTS[page_uri] || SPECIALS[page_uri] || page_uri}"
  end
