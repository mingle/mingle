(function (window) {
    ...
    c3_chart_internal_fn.initParams = function () {
        ...
        $$.isLegendRight = config.legend_position === 'right' || config.legend_position === 'top-right';
        $$.isLegendInset = config.legend_position === 'inset';
        $$.isLegendTop = ($$.isLegendInset && (config.legend_inset_anchor === 'top-left' || config.legend_inset_anchor === 'top-right')) ||
            ($$.isLegendRight && config.legend_position === 'top-right');
        $$.isLegendLeft = $$.isLegendInset && config.legend_inset_anchor === 'top-left' || config.legend_inset_anchor === 'bottom-left';
        $$.legendStep = 0;
        $$.legendItemWidth = 0;
        $$.legendItemHeight = 0;
    ...
    c3_chart_internal_fn.getHorizontalAxisHeight = function (axisId) {
        ...
        if (axisId === 'x' && !config.axis_rotated && config.axis_x_tick_rotate) {
            h = 30 + $$.axis.getMaxTickWidth(axisId) * Math.sin(Math.PI * Math.abs(config.axis_x_tick_rotate) / 180);
        }
        // Calculate y axis height when tick rotated
        if (axisId === 'y' && config.axis_rotated && config.axis_y_tick_rotate) {
            h = 30 + $$.axis.getMaxTickWidth(axisId) * Math.sin(Math.PI * Math.abs(config.axis_y_tick_rotate) / 180);
        }
    ...
    c3_chart_internal_fn.updateSizeForLegend = function (legendHeight, legendWidth) {
        ...
        $$.margin3 = {
            top: $$.isLegendRight ? ( $$.isLegendTop ? insetLegendPosition.top : 0 ) : $$.isLegendInset ? insetLegendPosition.top : $$.currentHeight - legendHeight,
            right: NaN,
            bottom: 0,
    ...
    c3_chart_internal_fn.updateLegend = function (targetIds, options, transitions) {
        ...
        function updatePositions(textElement, id, index) {
            ...
            function updateValues(id, withoutStep) {
                ...
                steps[id] = step;
                margins[step] = $$.isLegendInset ? 10 : $$.isLegendTop ? 0 :  margin;
